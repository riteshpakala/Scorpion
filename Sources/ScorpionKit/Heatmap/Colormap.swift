...
//  below τ are transparent — "not pinned" shows the image itself, not a colour.
//
...
public struct Colormap: Sendable {
    ...
    /// Orange, light (barely pinned) → dark (fully pinned).
    public static let memorization = Colormap(stops: [
