...
enum MainMenu {
    ...
    static func build(target: AppDelegate) -> NSMenu {
        ...
        let appMenu = NSMenu()
        appMenu.addItem(withTitle: "About Scorpion", action: #selector(NSApplication.orderFrontStandardAboutPanel(_:)), keyEquivalent: "")
        appMenu.addItem(.separator())
        appMenu.addItem(withTitle: "Hide Scorpion", action: #selector(NSApplication.hide(_:)), keyEquivalent: "h")
        appMenu.addItem(withTitle: "Quit Scorpion", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q")
        ...
        fileMenu.items = [open, scan, .separator(), export,
